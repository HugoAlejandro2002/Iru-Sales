    ...
    <div class="container">
        <div class="columns is-multiline">
            <div class="column is-12">
                ...
                <div class="buttons">
                    <router-link :to="{ name: 'EditLead', params: { id: lead.id } }" class="button is-light is-rounded">
                        Edit
                    </router-link>
                    <button @click="convertToClient" class="button is-info is-rounded">
                        Convert to client
                    </button>
                    <button @click="deleteLead" class="button is-danger is-rounded">
                        Delete
                    </button>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        async convertToClient() {
            ...
            await axios
                .post(`/api/v1/convert_lead_to_customer/`, data)
                .then(response => {
